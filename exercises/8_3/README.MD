...
1. [x] Dada uma matriz de matrizes, transforme em uma única matriz.
...
5. [x] Dada o array de nomes, retorne a quantidade de vezes em que aparecem a letra a maiúscula ou minúscula.
